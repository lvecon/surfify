...
import '../view_models/following_list_view_mode.dart';

class FollowingsList extends ConsumerStatefulWidget {
  final String uid;
  ...
  @override
  createState() => _FollowingsListState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        ...
        child: Scaffold(
          ...
          body: ref.watch(followingListProvider(widget.uid)).when(
